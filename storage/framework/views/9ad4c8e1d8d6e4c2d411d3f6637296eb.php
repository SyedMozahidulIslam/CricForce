    ...
    <div id="sidebar">
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <a class="dropdown-toggle" href="<?php echo e(route('users.index')); ?>">
                    Users
                </a>
              
            </li>
            <a href="<?php echo e(route('batting_stats.index')); ?>">
                <li class="list-group-item">Batting Stats</li>
            </a>
            <a href="<?php echo e(route('bowling_stats.index')); ?>">
            ...
            <a href="<?php echo e(route('stadiums.index')); ?>">
                <li class="list-group-item">Stadiums</li>
            </a>

            <a href="<?php echo e(route('match_schedules.index')); ?>">
...
<?php /**PATH C:\laragon\www\CricForce\resources\views/admin/layout/dashboard.blade.php ENDPATH**/ ?>